...
class DatasetBaseModel(models.Model):
    ...
    data_structure = models.CharField(max_length=20, choices=DATA_STRUCTURE_CHOICES, help_text="The data structure of the dataset", default="")
    growth_rate = models.CharField(max_length=20, choices=GROWTH_RATE_CHOICES, help_text="The growth rate of the dataset", default="")
    access_patterns = models.CharField(max_length=20, choices=ACCESS_PATTERN_CHOICES, help_text="The access pattern of the dataset", default="")
    query_complexity = models.CharField(max_length=20, choices=QUERY_COMPLEXITY_CHOICES, help_text="The related query complexity", default="")
