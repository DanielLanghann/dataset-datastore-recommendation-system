...
class Datastore(models.Model):
    ...
    type = models.CharField(
        max_length=20, choices=TYPE_CHOICES, help_text="Type of datastore"
    )
    system = models.CharField(
        max_length=20, choices=SYSTEM_CHOICES, help_text="Specific database system"
    )
    ...
    server = models.CharField(
        max_length=255, blank=True, null=True, help_text="Server hostname or IP address"
    )
    ...
    _encrypted_password = models.TextField(
        blank=True, null=True, help_text="Encrypted database password"
    )
    ...
    max_connections = models.PositiveIntegerField(
        blank=True, null=True, help_text="Maximum concurrent connections supported"
    )
